    ...
    public double Newpoint(double num) {
        return (getSlope() * num) + getyintercept();
    }
    ...
    public void LineInfo() {
        ...
        System.out.println("The distance of the line is: " + Round(getDistance()));
    }
}
